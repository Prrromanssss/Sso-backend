...
import (
	...
	"github.com/Prrromanssss/sso-backend/internal/lib/jwt"
	"github.com/Prrromanssss/sso-backend/internal/lib/logger/sl"
...
func (a *Auth) RegisterNewUser(
	...
	if err != nil {
		...
		log.Error("failed to dave user", sl.Err(err))
